...
return [
    ...
    */
    ...
    'ahrefs' => [
    	...
    	'jobs_count' => env('AHREFS_JOBS_COUNT', 2),
    	'sync_timeout' => env('AHREFS_SYNC_TIMEOUT', 10),
    	'jobs_timeout' => env('AHREFS_SYNC_TIMEOUT', 10),
    	'job_limit_window' => env('AHREFS_JOB_LIMIT_WINDOW', 10)
    ],
];

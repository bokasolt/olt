            ...
            <div class="col-md-8">
                <x-frontend.card>
                    <x-slot name="header">
                        ...
                        <h1 class="text-center m-4">@lang('Create Account')</h1>
                    </x-slot>
                    ...
                    <x-slot name="body">
                        <x-forms.post :action="route('frontend.auth.register')">
                                ...
                                <div class="col-md-6 offset-md-4">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="terms">
                                            @lang('I agree to the') <a href="{{ route('frontend.content', 'terms') }}" target="_blank">@lang('Terms & Conditions')</a>
                                        </label>
                                    </div>
                                </div>
                            </div><!--form-group-->
                            ...
                            <div class="form-group row">
                                <div class="col-md-6 offset-md-4">
                                    <button class="btn btn-primary" type="submit">@lang('Create Account')</button>
                                </div>
                            </div><!--form-group-->

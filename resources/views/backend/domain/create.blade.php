...
@section('content')
    <x-forms.post :action="route('admin.domain.store')">
        <x-backend.card>
            <x-slot name="header">
                @lang('Add Domain')
            </x-slot>
            ...
            <x-slot name="body">
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="domain" id="domain" class="form-control" placeholder="{{ __('Domain') }}"
                               value="{{ old('domain') }}" maxlength="255" required/>
                    </div>
                </div><!--form-group-->
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-4">
                            <select name="niche" class="form-control" required x-on:change="niche = $event.target.value">
                                ...
                                <option value="{{ $k }}" {{ $k === (old('niche') ?? '') ? 'selected' : '' }}>{{ $v }}</option>
                                @endforeach
                            </select>
                    </div>
                </div><!--form-group-->
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-2">
                            <select name="lang" class="form-control" id="lang" required x-on:change="lang = $event.target.value">
                                @foreach ($lists['lang'] as $k => $v)
                                <option value="{{ $k }}" {{ $k === (old('lang') ?? '') ? 'selected' : '' }}>{{ $v }}</option>
                                @endforeach
                            </select>
                    </div>
                </div><!--form-group-->
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="title" id="title" class="form-control"
                               ...
                               value="{{ old('title') }}" maxlength="1023"/>
                    </div>
                </div><!--form-group-->
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="number" name="ahrefs_dr" id="ahrefs_dr" class="form-control"
                               ...
                               value="{{ old('ahrefs_dr') }}" maxlength="32"/>
                    </div>
                </div><!--form-group-->
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="number" name="ahrefs_traffic" id="ahrefs_traffic" class="form-control"
                               ...
                               value="{{ old('ahrefs_traffic') }}" maxlength="32"/>
                    </div>
                </div><!--form-group-->
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="number" name="linked_domains" id="linked_domains" class="form-control"
                               ...
                               value="{{ old('linked_domains') }}" maxlength="32"/>
                    </div>
                </div><!--form-group-->
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="number" name="num_organic_keywords_top_10" id="num_organic_keywords_top_10"
                               ...
                               value="{{ old('num_organic_keywords_top_10') }}"
                               maxlength="32"/>
                    </div>
                </div><!--form-group-->
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-4">
                            <select name="article_by" class="form-control" id="article_by" required x-on:change="article_by = $event.target.value">
                                ...
                                <option value="{{ $k }}" {{ $k === (old('article_by') ?? 'CLIENT') ? 'selected' : '' }}>{{ $v }}</option>
                                @endforeach
                            </select>
                    </div>
                </div><!--form-group-->
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-2">
                            <select name="sponsored_label" class="form-control" id="sponsored_label_fld" required x-on:change="sponsored_label = $event.target.value">
                                ...
                                <option value="{{ $k }}" {{ $k === (old('sponsored_label') ?? 'NO') ? 'selected' : '' }}>{{ $v }}</option>
                                @endforeach
                            </select>
                    </div>
                </div><!--form-group-->
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-4">
                            <select name="type_of_publication" class="form-control" id="type_of_publication" required x-on:change="type_of_publication = $event.target.value">
                                @foreach ($lists['type_of_publication'] as $k => $v)
                                <option value="{{ $k }}" {{ $k === (old('type_of_publication') ?? 'ARTICLE') ? 'selected' : '' }}>{{ $v }}</option>
                                @endforeach
                            </select>
                    </div>
                </div><!--form-group-->
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                            <select name="type_of_link" class="form-control" id="type_of_link" required x-on:change="type_of_link = $event.target.value">
                                ...
                                <option value="{{ $k }}" {{ $k === (old('type_of_link') ?? 'DOFOLLOW') ? 'selected' : '' }}>{{ $v }}</option>
                                @endforeach
                            </select>
                    </div>
                </div><!--form-group-->

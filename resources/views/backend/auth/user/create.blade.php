        ...
        <x-backend.card>
            ...
            <x-slot name="body">
                <div x-data="{userType : '{{ $model::TYPE_USER }}'}">
                    ...
                    <div class="form-group row">
                        <label for="paid" class="col-md-2 col-form-label">@lang('Paid')</label>

                        <div class="col-md-10">
                            <div class="form-check">
                                <input name="paid" id="paid" class="form-check-input" type="checkbox" value="1" {{ old('paid') ? 'checked' : '' }} />
                            </div><!--form-check-->
                        </div>
                    </div><!--form-group-->

                    <div class="form-group row">
                        <label for="balance" class="col-md-2 col-form-label">@lang('Balance')</label>

                        <div class="col-md-10">
                            <input type="number" name="balance" id="balance" class="form-control" placeholder="{{ __('Balance') }}" value="{{ old('balance') ?? 0 }}" required />
                        </div>
                    </div><!--form-group-->

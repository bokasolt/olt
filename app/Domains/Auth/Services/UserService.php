...
class UserService extends BaseService
{
    ...
    public function update(User $user, array $data = []): User
    {
        ...
        try {
            ...
            if (array_key_exists('balance', $data)) {
                $updateVals['balance'] = $data['balance'];

                $updateVals['paid'] = false;
                if (array_key_exists('paid', $data)) {
                    $updateVals['paid'] = true;
                }
            }
            ...
            throw new GeneralException(__('There was a problem updating this user. Please try again.' . $e->getMessage()));
        }
    ...
    public function increaseBalance(User $user, int $amount)
    {
        $user->paid = true;
